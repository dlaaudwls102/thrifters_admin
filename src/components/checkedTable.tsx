...
const rows = [createData('2021-08-25', '03:20', '신영관', 300, 4000)];
...
export default function CheckedTable() {
    ...
    const [orderHistory, setOrderHistory] = React.useState([
        createData('2021-08-25', '03:20', '신영관', 300, 3000),
    ]);
    ...
    const finished = (user: string) => {
        ...
        selectedOrder['payConfirmed_Time'] = new Intl.DateTimeFormat('en-US', {
            year: 'numeric',
            month: '2-digit',
            day: '2-digit',
            hour: '2-digit',
        ...
        db.collection('orders')
            ...
            .update({
                orders: orderHistory.filter(
                    (order) => order.payConfirmed_Time !== selected[0]
                ),
            });
        console.log(
            '[' + Date.now() + ']' + 'DONE deleting Data from admin user orders'
        );
    };
