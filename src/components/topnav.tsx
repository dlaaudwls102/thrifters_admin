...
const TopNav = () => {
    ...
    return(
      ...
      <a id="2" onClick={onClickHeaderBtn.bind(this,2, "/finalize")} className={page == 2 ? "pressed" : ""}>매입정산</a>
      <a id="3" onClick={onClickHeaderBtn.bind(this,3, "/confirmed")} className={page == 3 ? "pressed" : ""}>누적현황</a>
